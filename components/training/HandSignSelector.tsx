        ...
        {sealsList.map((seal) => {
          ...
          return (
            <button
              ...
              className={`relative flex flex-col items-center justify-between p-2.5 rounded-xl border transition-all duration-200 group text-left ${
                isSelected
            ...
            >
              ...
              {isMastered && (
                <div
                  className="absolute -top-1.5 -right-1.5 w-5 h-5 rounded-full bg-emerald-500 border border-emerald-200 flex items-center justify-center text-black text-[10px] font-bold shadow-md shadow-emerald-500/50"
                  title="Sign Mastered!"
                >
                  ✓
                </div>
